...
% partial
% heavy
function kaist_eval_full(dtDir, gtDir, reval, writeRes, savePath)

if nargin < 3, reval = true; end
if nargin < 5, writeRes = false; end
...
fprintf('%-30s \t log-average miss rate = %02.2f%% recall = %02.2f%%\n', iexp{1}, miss_imp*100, roc_imp(end, 3)*100);
